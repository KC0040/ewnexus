...
| 項目 | 金額 | 說明 |
|------|------|------|
| 建站費 | $600 一次 | 含5頁、主機Year1、Email、基本SEO、聯絡表單、3次修改、AI聊天、Clarity、GA4、GSC |
| 網域代辦 | +$50 | 代購並設定DNS，節省客戶時間；網域費用實報實銷（約$12–15/年） |
| GPS三方追蹤系統 | +$400 | 客戶/司機/店主三方即時定位，適合拖車、道路救援、行動輪胎 |
| 單次維護 | $150/次 | 無年度合約時的單次修改 |
| 年度維護 Standard | $150/年 | 2次內容更新，靜態網站適用 |
| 年度維護 Plus | $250/年 | 4次內容更新，GPS網站建議選此方案 |
| 加頁面 | $100/頁 | 超出標準5頁 |
| 進階SEO | 另外報價 | 關鍵字策略、內容優化，不含在$600內 |
| 社媒管理 | 另外報價 | 不含在標準方案，避免客戶亂要 |
...
❌ 禁止出現 $500、$10/月、$20/月、$12/年、$35/年、$9.13/月 這些舊數字。
❌ AI聊天已含在$600內，不得另外收月費。
